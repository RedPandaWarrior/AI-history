class OpenPanelBtn extends Button{
    ...
    setInitialPosition(){
        const panel = document.querySelector(platformConfig.chatPanelSl)
        const test = document.querySelector('.b8812f16.a2f3d50e._70b689f')
        const panelRect = panel.getBoundingClientRect();
        const testlRect = test.getBoundingClientRect();
        console.log(panelRect.top,panelRect.height)
        console.log(testRect.top,testRect.height)
        this.btnEle.style.position = 'absolute';
        this.btnEle.style.top = `${panelRect.top + panelRect.height/2}px`
