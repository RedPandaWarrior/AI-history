...
const userMsgPanel = {
    ...
    // Slide mode btn
        this.toggleLayoutModeBtn = new window.Button({
            className:'toggle-layout-mode-btn',
            text:'侧边固定',
            onclick:()=>{ 
                this.panelInstance.toggleLayoutMode() 
                this.toggleLayoutModeBtn.className = 
    ...
    // create DOM
        ...
        this.panelInstance.panelEle.appendChild(this.toggleLayoutModeBtn);
