class Panel{
    ...
    toggleLayoutMode(){
        console.log(1)
        if (this.panelEle.classList.contains('side')){
            this.panelEle.classList.remove('side');
            this.panelEle.classList.add('float');
        } else{
            this.panelEle.classList.remove('float');
            this.panelEle.classList.add('side');
        }
    }
